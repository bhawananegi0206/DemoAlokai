...
const f = d((i, o) => {
  const { open: s, onToggle: e, children: t, summary: r, summaryClassName: c, ...n } = i;
  return /* @__PURE__ */ l("details", { ref: o, open: s, "data-testid": "accordion-item", ...n, children: [
    /* @__PURE__ */ m(
      "summary",
      {
        onClick: (a) => {
          a.preventDefault(), e == null || e(!s);
        },
        className: u(
          c,
